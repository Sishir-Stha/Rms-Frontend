...
export const DEVICE_CATEGORIES: DeviceCategoryRecord[] = [
...
export const REPAIRS: RepairRecord[] = [
  { id: 'REP-001', device: 'Dell Inspiron 15', deviceCategory: 'Laptops', issue: 'Battery not charging, powers off unexpectedly', reportedBy: 'Emily Chen', reportedDate: '2026-03-01', technician: 'James Rodriguez', vendor: 'TechFix Solutions', status: 'Closed', priority: 'High', expectedCompletion: '2026-03-08', resolvedDate: '2026-03-07', cost: 4500, serialNo: 'SN-DL15-2023-001', department: 'Finance', kanbanColumn: 'Closed' },
  ...
  { id: 'REP-003', device: 'Lenovo ThinkPad X1', deviceCategory: 'Laptops', issue: 'Screen flickering and display artifacts', reportedBy: 'David Kim', reportedDate: '2026-03-05', technician: 'Sarah Mitchell', vendor: 'TechFix Solutions', status: 'Open', priority: 'High', expectedCompletion: '2026-03-27', resolvedDate: null, cost: 0, serialNo: 'SN-LN-TP-X1-089', department: 'IT', kanbanColumn: 'Open' },
  { id: 'REP-004', device: 'iPhone 14 Pro', deviceCategory: 'Mobile Phones', issue: 'Cracked screen and touch not responding', reportedBy: 'Priya Patel', reportedDate: '2026-03-06', technician: 'James Rodriguez', vendor: 'QuickRepair Co.', status: 'Resolved', priority: 'Low', expectedCompletion: '2026-03-28', resolvedDate: null, cost: 8500, serialNo: 'SN-IP14P-2024-021', department: 'Operations', kanbanColumn: 'Resolved' },
  { id: 'REP-005', device: 'Canon PIXMA', deviceCategory: 'Printers', issue: 'Ink cartridge error and color distortion', reportedBy: 'Emily Chen', reportedDate: '2026-03-07', technician: 'Michael Torres', vendor: 'Elite Tech Services', status: 'Closed', priority: 'Low', expectedCompletion: '2026-03-14', resolvedDate: '2026-03-12', cost: 1800, serialNo: 'SN-CN-PIX-033', department: 'Finance', kanbanColumn: 'Closed' },
  ...
  { id: 'REP-007', device: 'MacBook Pro 16"', deviceCategory: 'Laptops', issue: 'Keyboard keys not responding, spill damage', reportedBy: 'Sarah Mitchell', reportedDate: '2026-03-09', technician: 'James Rodriguez', vendor: 'TechFix Solutions', status: 'Open', priority: 'High', expectedCompletion: '2026-03-30', resolvedDate: null, cost: 0, serialNo: 'SN-MB-PRO16-2023-007', department: 'IT', kanbanColumn: 'Open' },
  { id: 'REP-008', device: 'Samsung Galaxy S23', deviceCategory: 'Mobile Phones', issue: 'Overheating during calls and charging', reportedBy: 'Lisa Park', reportedDate: '2026-03-10', technician: 'Sarah Mitchell', vendor: 'QuickRepair Co.', status: 'Closed', priority: 'Medium', expectedCompletion: '2026-03-17', resolvedDate: '2026-03-16', cost: 3200, serialNo: 'SN-SG-S23-2024-034', department: 'HR', kanbanColumn: 'Closed' },
  { id: 'REP-009', device: 'Cisco Catalyst 2960', deviceCategory: 'Network Equipment', issue: 'Port failure, network connectivity loss', reportedBy: 'David Kim', reportedDate: '2026-03-11', technician: 'David Kim', vendor: 'ProMend Systems', status: 'Resolved', priority: 'Critical', expectedCompletion: '2026-03-23', resolvedDate: null, cost: 0, serialNo: 'SN-CSC-2960-009', department: 'IT', kanbanColumn: 'Resolved' },
  ...
  { id: 'REP-011', device: 'HP EliteBook 840', deviceCategory: 'Laptops', issue: 'Windows update failure, blue screen errors', reportedBy: 'Emily Chen', reportedDate: '2026-03-13', technician: 'Sarah Mitchell', vendor: 'TechFix Solutions', status: 'Closed', priority: 'Medium', expectedCompletion: '2026-03-20', resolvedDate: '2026-03-19', cost: 2000, serialNo: 'SN-HP-EB-840-078', department: 'Finance', kanbanColumn: 'Closed' },
  { id: 'REP-012', device: 'Dell UltraSharp 27"', deviceCategory: 'Monitors', issue: 'Dead pixels and backlight bleeding', reportedBy: 'David Kim', reportedDate: '2026-03-14', technician: 'James Rodriguez', vendor: 'TechFix Solutions', status: 'Open', priority: 'Low', expectedCompletion: '2026-04-01', resolvedDate: null, cost: 0, serialNo: 'SN-DL-US27-2024-011', department: 'IT', kanbanColumn: 'Open' },
  ...
  { id: 'REP-014', device: 'Logitech MX Master', deviceCategory: 'Network Equipment', issue: 'Scroll wheel not working, buttons unresponsive', reportedBy: 'Lisa Park', reportedDate: '2026-03-16', technician: 'Michael Torres', vendor: 'Swift Tech Nepal', status: 'Closed', priority: 'Low', expectedCompletion: '2026-03-18', resolvedDate: '2026-03-17', cost: 800, serialNo: 'SN-LG-MX-2024-022', department: 'HR', kanbanColumn: 'Closed' },
  { id: 'REP-015', device: 'iPad Pro 12.9"', deviceCategory: 'Tablets', issue: 'Charging port damaged, not syncing', reportedBy: 'Priya Patel', reportedDate: '2026-03-17', technician: 'Sarah Mitchell', vendor: 'QuickRepair Co.', status: 'Open', priority: 'Medium', expectedCompletion: '2026-04-02', resolvedDate: null, cost: 0, serialNo: 'SN-IPD-PRO129-019', department: 'Operations', kanbanColumn: 'Open' },
  { id: 'REP-016', device: 'Lenovo IdeaPad 3', deviceCategory: 'Laptops', issue: 'RAM failure, frequent random crashes', reportedBy: 'Emily Chen', reportedDate: '2026-03-18', technician: 'James Rodriguez', vendor: 'TechFix Solutions', status: 'Resolved', priority: 'High', expectedCompletion: '2026-03-29', resolvedDate: null, cost: 0, serialNo: 'SN-LN-IP3-2024-041', department: 'Finance', kanbanColumn: 'Resolved' },
  ...
  { id: 'REP-018', device: 'HP Pavilion 15', deviceCategory: 'Laptops', issue: 'Touchpad clicking but cursor not moving', reportedBy: 'David Kim', reportedDate: '2026-03-20', technician: 'Sarah Mitchell', vendor: 'TechFix Solutions', status: 'Open', priority: 'Low', expectedCompletion: '2026-04-05', resolvedDate: null, cost: 0, serialNo: 'SN-HP-PAV15-052', department: 'IT', kanbanColumn: 'Open' },
  { id: 'REP-019', device: 'Cisco IP Phone 7942', deviceCategory: 'Network Equipment', issue: 'No dial tone, voice quality issues', reportedBy: 'Michael Torres', reportedDate: '2026-03-21', technician: 'David Kim', vendor: 'ProMend Systems', status: 'Open', priority: 'High', expectedCompletion: '2026-04-03', resolvedDate: null, cost: 0, serialNo: 'SN-CSC-7942-015', department: 'IT', kanbanColumn: 'Open' },
  { id: 'REP-020', device: 'Samsung Galaxy Tab', deviceCategory: 'Tablets', issue: 'App crashes, insufficient storage error', reportedBy: 'Priya Patel', reportedDate: '2026-03-22', technician: 'James Rodriguez', vendor: 'QuickRepair Co.', status: 'Closed', priority: 'Low', expectedCompletion: '2026-03-25', resolvedDate: '2026-03-22', cost: 1500, serialNo: 'SN-SG-TAB-2024-031', department: 'Operations', kanbanColumn: 'Closed' },
]

export const DEVICE_REQUESTS: DeviceRequestRecord[] = [
...
export const SUPPORT_TICKETS: SupportTicketRecord[] = [
