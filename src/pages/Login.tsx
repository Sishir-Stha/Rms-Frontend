  ...
  return (
    <div className="min-h-screen flex" style={{ background: '#0b1326' }}>
      ...
      >
        ...
        <div
          className="orb w-48 h-48 bottom-20 right-0 animate-float-slow"
          style={{ background: '#adc6ff', animationDelay: '2s' }}
        />
        ...
        <div className="relative z-10 flex flex-col h-full p-10">
          <div className="flex items-center gap-3">
            <div
              ...
              style={{
                background: 'linear-gradient(135deg, #62df7d, #1ca64d)',
                boxShadow: '0 0 30px rgba(98,223,125,0.4)',
              }}
            >
          ...
          <div className="mt-auto mb-12">
            ...
            <p className="text-on-surface-variant text-sm leading-relaxed">
              Track every repair, manage device requests, and gain powerful insights into
              your IT operations all in one place.
            </p>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6" style={{ background: '#131b2e' }}>
        <div className="w-full max-w-md">
          ...
          <div
            ...
            style={{ background: '#1e2a42', border: '1px solid rgba(62,74,61,0.2)' }}
          >
            <div className="mb-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button
                    type="button"
                    onClick={() => setShowPwd((currentValue) => !currentValue)}
              ...
              {error && (
                <div
                  className="px-4 py-3 rounded-xl text-sm text-error"
                  style={{
